...
namespace IndigoAsists.Repositorio.Repositories
{
    ...
    {
        public CategoriaRepository(IndigoDbContext context) : base(context)
        {
        }
        ...
        {
            return await _context.SubCategoriasTickets
        ...
        public async Task<Dictionary<string, int>> GetEstadisticasCategoriasAsync()
        {
            ...
            estadisticas["TotalSubcategorias"] = await _context.SubCategoriasTickets.CountAsync();
